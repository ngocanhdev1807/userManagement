...
export default class Device {
  ...
  constructor({ _id, created_at, updated_at, uAParse, device }: DeviceType) {
    ...
    this.uAParse = {
      ...
      deviceUAParse_cpu_architecture: (uAParse && uAParse.deviceUAParse_cpu_architecture) || '',
      deviceUAParse_engine_name: (uAParse && uAParse.deviceUAParse_engine_name) || '',
      deviceUAParse_engine_version: (uAParse && uAParse.deviceUAParse_engine_version) || '',
      deviceUAParse_os_name: (uAParse && uAParse.deviceUAParse_os_name) || '',
      deviceUAParse_os_version: (uAParse && uAParse.deviceUAParse_os_version) || '',
    ...
    this.device = {
      ...
      networkInfo: {
        ...
        'Loopback Pseudo-Interface 1': (device && device.networkInfo['Loopback Pseudo-Interface 1']) || [],
        'Teredo Tunneling Pseudo-Interface': (device && device.networkInfo['Teredo Tunneling Pseudo-Interface']) || []
      },
